...
fig = plt.figure()
kdefig1(fig, dtf_DC, dtf_NC, dtf_PC, 'Belief', 0.6)
plt.legend(['DC', 'NC', 'PC'])
plt.grid(True)

fig1 = plt.figure()
kdefig2(fig1, dtf_DC, dtf_NC, dtf_PC, 'Belief', 0.6)
plt.legend(['DC', 'NC', 'PC'])
plt.grid(True)


fig2, axes = plt.subplots(1, 3, sharey=True)
boxes(fig2, dtf_DC, dtf_NC, dtf_PC, 'Belief')
...
violins(fig3, dtf_DC, dtf_NC, dtf_PC, 'Belief')
axes[1].set(ylabel=None)
axes[2].set(ylabel=None)
axes[0].legend(['DC'])
axes[1].legend(['NC'])
...
regplots(fig4, dtf_DC, dtf_NC, dtf_PC, 'PerAllo', 'Belief')
axes[1].set(ylabel=None)
axes[2].set(ylabel=None)
axes[0].legend(['DC'])
axes[1].legend(['NC'])
...
regplots(fig5, dtf_DC, dtf_NC, dtf_PC, 'Objective', 'Belief')
axes[1].set(ylabel=None)
axes[2].set(ylabel=None)
axes[0].legend(['DC'])
axes[1].legend(['NC'])
